...
//    app.get('/api/smartlists/:projectId/:type', ogcSmartList.findAllByType);
//    app.get('/api/smartlists/:projectId/:type/:id', ogcSmartList.findById);
    app.post('/api/smartlists/:projectId/:type', ogcSmartList.add);
//      app.put('/api/smartlists/:projectId/:type', ogcSmartList.update);
//    app.delete('/api/smartlists/:projectId/:type', ogcSmartList.remove);
