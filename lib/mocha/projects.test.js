...
describe('Project Tests', function() {
    ...
    describe('Base Project Tests', function() {
        ...
        it('Should Add a New Project', function(done) {
            ...
            newSimpleProject.Channel = 'Digital';
        ...
        it('Should return 1 project types', function(done) {
            request(api)
        ...
        it('Should return 0 projects of Type Undefined', function(done) {
            request(api)
                .get('/api/projects/type/undefined')
                .expect(200)
                .end(function(err, res) {
                    if (err) {
                        throw err;
