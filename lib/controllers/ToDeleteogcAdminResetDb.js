...
var populateBaseProperties = function() {
    ...
    var ogcChannelTypes = './lib/mocha/testdata/ogcChannelTypes.json';
    fs.readFile(ogcChannelTypes, 'utf8', function(err, data) {
        if (err) {
            throw err;
        }
        var objects = JSON.parse(data);
    ...
    if (key !== '@ogcCarb0n') {
        ...
        async.waterfall([
            function(callback) {
                ...
                db.collection('ogcChannelTypes').remove({},function(){
                    console.log("remove ogc Channel types");
                });
                ...
                db.collection('ogcSmartLists').remove({},function(){
                    console.log("remove ogc smartlists");
                });
                db.collection('ogcObjectTypes').remove({},function(){
                    console.log("remove ogc types");
                });
