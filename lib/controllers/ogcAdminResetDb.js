...
var populateBaseProperties = function() {
    var fs = require('fs');
    var ogcObjects = '././test/testdata/ogcObjects.json';
    ...
    var ogcObjectTypes = '././test/testdata/ogcObjectTypes.json';
    ...
    var ogcFieldTypes = '././test/testdata/ogcFieldTypes.json';
    ...
    var ogcTags = '././test/testdata/ogcTags.json';
